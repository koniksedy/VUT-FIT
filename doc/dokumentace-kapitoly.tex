...
\chapter{Použití programu}
    ...
    \section{Automatické testy}
        ...
        Za účelem vyžší přehlednosti je během testování tištěna informace o počtu provedených testů pomocí knihovny \texttt{tqdm}\footnote{Tqdm je dostupné z: \url{https://tqdm.github.io}} (verze 4.64.1). Tato knihovna se souběžně instaluje se závislostmi pro program \texttt{enum\_cycles.py}.
...
\chapter{Experimenty}
    ...
    Během implementace programu se ukázalo, že nested grafy jsou nevhodné pro porovnávání algoritmu (všechny algoritmy byly stejně efektivní). Z tohoto důvodu byly nested grafy použity pouze pro testování.
    ...
    Měření byla prováděna na procesoru AMD Ryzen 7 5800H (3.2 GHz) s 8 jádry a 16 vláky s 16 GB RAM.

    V tabulkách jsou uvedeny popuze zkratky pro jednotlivé algoritmy(NX = algoritmus knihovny networkx, BF = Brute-Force algoritmus, WEIN =  Herberta Weinblattův algoritmus, HJ = algoritmus Hongbo Liu a Jiaxin Wanga).
    ...
    \section{Úplné grafy}
        \begin{table}[!h]
            ...
            \begin{tabular}{|| l | l || r | r | r | r || r | r | r | r ||}
                \hline
                \multicolumn{2}{|| c ||}{-----} & \multicolumn{4}{c ||}{Čas [s]} & \multicolumn{4}{c ||}{Paměť [KB]}\\
                \hhline{==========}
                ...
                \hline
            \end{tabular}
            \caption{Spotřebovaný čas a paměť při prohledávání úplných grafů s různou velikostí.}
        \end{table}

    \section{Mulit-cyklické grafy}
        \begin{table}[!h]
            \centering
            \begin{tabular}{|| l | l || r | r | r | r || r | r | r | r ||}
                \hline
                ...
                \hline
            \end{tabular}
            \caption{Maximální časový limit byl 120 sekund.}
        \end{table}
