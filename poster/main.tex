...
\begin{columns}
    ...
    \block{Snort} {
        ...
        \begin{tikzfigure}[\textsc{Reduction results of RABIT/Reduce (RAB) and procedures (Proc) on seven sets of Snort rules. $Q$ denotes the number of states $\delta$ the number of transitions, and $\Gamma$ the number of stack symbols. The percentages refer to RABIT/Reduce results.}\par]
            \centering
            \small
