...
\section{Automata operations}
    ...
    \subsection{Complement}
        ...
        The accepting property of the initial states has to be handled differently. This state has a special meaning, it is used to encode boolean values. Therefore, if it is marked as accepting, then it will be unmarked, otherwise it will remain unaccepted.
        ...
        \While{$queue \neq \emptyset$}{
            ...
            \uIf{$\iota_M(s_M) = \iota_N(s_N)$}{
                \ForAll{$a \in \Sigma_M \cap \Sigma_N : \delta_M(s_M, a) \in Q_M \land \delta_N(s_N, a) \in Q_N$}{
                    ...
                    $queue.push((\delta_M(s_M, a), \delta_N(s_N, a)))$\;
                }
                ...
                \ForAll{$a \in \Sigma_M : \delta_M(s_M, a) \in Q_M$}{
                    ...
                    $queue.push((\delta_M(s_M, a), s_N))$\;
                }
            }\Else{
                \ForAll{$a \in \Sigma_M : \delta_M(s_M, a) \in Q_M$}{
                    $\delta(s, a) \leftarrow (s_M, \delta_N(s_N, a))$\;
                    $queue.push((s_M, \delta_N(s_N, a)))$\;
                }
            }
        }
        \Return{$A$}\;
    ...
    \subsection{Determinization}
        ...
        \begin{algorithm}
            ...
            \KwOut{A DFA $A = (Q \subseteq 2^{Q_M}, \Sigma, \delta, i, F)$ such that $L(M) = L(A)$ and index function $\iota : Q \rightarrow \mathbb{N}_0$}
