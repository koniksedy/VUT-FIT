...
\section{Preliminaries}
    ...
    \subsection{Binary Decision Diagrams}
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}{0.25\textwidth}
                ...
                \begin{tikzpicture}[node distance=0.4cm and 0.3cm]\footnotesize
                 ...
                 \end{tikzpicture}
            \end{subfigure}
            \caption{From the left to the right, OBDD meeting the first condition, the second condition and the third condition from the definition.}
        \end{figure}
        ...
        \begin{theorem}
            \label{theorem:ROBDD}
            For every Boolean function $\phi$ over some se of variables $Var$ and every variable ordering $\prec$ on $Var$, there is a unique (up to isomorphism) reduced OBDD (wrt $\prec$) $G_\phi$ which represents $\phi$. \cite{BDD}
        \end{theorem}
